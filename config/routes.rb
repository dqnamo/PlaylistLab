Rails.application.routes.draw do
  ...
  get '/add_danceability/:id', to: 'enhance_playlist#add_danceability', as: :add_danceability
  get '/remove_danceability/:id', to: 'enhance_playlist#remove_danceability', as: :remove_danceability
end
